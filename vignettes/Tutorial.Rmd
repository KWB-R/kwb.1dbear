...
# Combine the plots
print(kwb.1dbear::plot_combined(bear1d_list = bear1d_tahi_combined))
...
# Combine the plots
print(kwb.1dbear::plot_combined(bear1d_list = bear1d_surany_combined))
...
# Combine the plots
print(kwb.1dbear::plot_combined(bear1d_list = bear1d_vienna_combined))
